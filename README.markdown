# The Official Avenue Code Swift Style Guide.

This style guide is forked from raywenderlich.com and customized for our use at Avenue Code. We created this style guide to keep the code in projects, tutorials, and starter kits nice and consistent — even though we have many different authors working on them.
...
The original style guide was forked from raywenderlich.com and we have been customizing it to match our company needs.

As the original authors, we also drew inspiration from Apple’s reference material on Swift:
